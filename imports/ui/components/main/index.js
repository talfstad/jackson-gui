    ...
    <ul className="nav navbar-nav">
      <li className="dropdown dropdown-fw dropdown-fw-disabled  active open selected">
        ...
        <ul className="dropdown-menu dropdown-menu-fw">
          <li className="active">
            <a href="index.html">
              <i className="icon-chart" /> Default </a>
          </li>
          <li>
            <a href="dashboard_2.html">
              <i className="icon-bulb" /> Dashboard 2 </a>
          </li>
          <li>
            <a href="dashboard_3.html">
              <i className="icon-graph" /> Dashboard 3 </a>
          </li>
        </ul>
      </li>
      <li className="dropdown dropdown-fw dropdown-fw-disabled  ">
        <a href="#jkfj" className="text-uppercase">
          <i className="icon-puzzle" /> Features </a>
        <ul className="dropdown-menu dropdown-menu-fw">
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-diamond" /> UI Features </a>
          ...
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-puzzle" /> Components </a>
            <ul className="dropdown-menu">
              <li>
          ...
          <li className="dropdown more-dropdown-sub">
            <a href="#d">
              <i className="icon-settings" /> Form Stuff </a>
            <ul className="dropdown-menu">
              <li>
          ...
          <li className="dropdown more-dropdown-sub">
            <a href="?p=">
              <i className="icon-wallet" /> Portlets </a>
            <ul className="dropdown-menu">
              <li>
          ...
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-bar-chart" /> Charts </a>
            <ul className="dropdown-menu">
              <li>
              ...
              <li>
                <a href="#jkfj"> HighCharts </a>
              </li>
            </ul>
          </li>
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-cloud-upload" /> Elements </a>
            <ul className="dropdown-menu">
              <li>
          ...
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-pointer" /> Maps </a>
            <ul className="dropdown-menu">
              <li>
      ...
      <li className="dropdown dropdown-fw dropdown-fw-disabled  ">
        <a href="#jkfj" className="text-uppercase">
          <i className="icon-briefcase" /> Tables </a>
        <ul className="dropdown-menu dropdown-menu-fw">
          <li>
      ...
      <li className="dropdown dropdown-fw dropdown-fw-disabled  ">
        <a href="#jkfj" className="text-uppercase">
          <i className="icon-layers" /> Pages </a>
        <ul className="dropdown-menu dropdown-menu-fw">
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-basket" /> eCommerce </a>
            <ul className="dropdown-menu">
              <li>
          ...
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-social-dribbble" /> General </a>
            <ul className="dropdown-menu">
              <li>
              ...
              <li>
                <a href="page_general_pricing_2.html">
                  <i className="icon-tag" /> Pricing 2 </a>
              </li>
              <li>
          ...
          <li className="dropdown more-dropdown-sub">
            <a href="#jkfj">
              <i className="icon-settings" /> System </a>
            <ul className="dropdown-menu">
              <li>
      ...
      <li className="dropdown more-dropdown">
        <a href="#jkfj" className="text-uppercase"> More </a>
        <ul className="dropdown-menu">
          <li>
            <a href="#df">Link 1</a>
          </li>
